...
int main(int argc, char **argv) {
  ...
  const double k_vertical_thrust = 80;//68.5;  // with this thrust, the drone lifts.
  const double k_vertical_offset = 1;//0.6;   // Vertical offset where the robot actually targets to stabilize itself.
